...
var Swipeable = function (_React$Component) {
  ...
  _createClass(Swipeable, null, [{
    ...
    get: function get() {
      return {
        config: (0, _defineSwipe2.default)(),
  ...
  _createClass(Swipeable, [{
    ...
    value: function handleTouchMove(touchPosition) {
      ...
      this.props.config.determineSwipe(touchPosition, this.state.initial, this.props, function () {
        if (_this2.props.config.updateEvery == 0) {
